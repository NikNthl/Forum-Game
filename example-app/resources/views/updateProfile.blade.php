        ...
        <div class="card border-0 shadow rounded-3 my-5">
          <div class="card-body p-4 p-sm-5">
            ...
            <div class="form-floating mb-3">
                <input type="username" class="form-control" id="floatingInput" placeholder="Change Username">
              </div>
              <div class="form-floating mb-3">
                <input type="email" class="form-control" id="floatingInput" placeholder="Change Email">
              </div>
